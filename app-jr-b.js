...
async function generatePDF(){
  ...
  doc.text('SOLICITUD ASOCIADO JR 30 A 34 AÑOS',119,35,{align:'center'});
  ...
  let y=83;
  const p1=`Solicito sea admitido(a) mi hijo(a) ${hijo}, quien nació el día ${nac}, en la Categoría de “ASOCIADO JR” y como tal continúe haciendo uso de las instalaciones del CLUB ATLAS CHAPALITA, en tanto no cumpla los 35 años y permanezca soltero(a).`;
  const p2='Al mismo tiempo, acepto que la cuota para asociado JUNIOR, que para este caso es del 25% (veinticinco) de la mensualidad vigente, sea incluida automáticamente en mi estado de cuenta, en la inteligencia que tengo el derecho en cualquier momento de renunciar a esta categoría, mediante simple aviso por escrito al CLUB y/o entrega de credencial de asociado, por ende se dejará de cobrar a partir del siguiente mes.';
  ...
  doc.save(`Solicitud_JR_B_${safe||'Asociado'}.pdf`);
